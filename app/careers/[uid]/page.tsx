...
import CareerFormDialog from "@/components/dialogs/CareerFormDialog";
...
export default async function Page({ params }: { params: Promise<Params> }) {
  ...
  return (
    <div className="block-space narrow-container">
      ...
      <article className="prose max-w-none dark:prose-invert md:prose-lg prose-headings:mb-4 prose-h2:mt-8 prose-p:text-muted-foreground prose-ul:text-base">
