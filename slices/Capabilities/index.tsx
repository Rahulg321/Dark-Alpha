      ...
      <div className="big-container">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 rounded-xl px-6 py-8 shadow-md md:mt-12 md:grid-cols-2">
          ...
          <div>
            <h2>Contact Us</h2>
            <span className="mt-4 block font-semibold text-gray-600">
              As an independent sponsor, we welcome the opportunity to engage
              with you. Whether you seek information, have proposals, or simply
              wish to initiate dialogue, your outreach is highly valued. Connect
              with Dark Alpha today, and let's embark on a journey toward
